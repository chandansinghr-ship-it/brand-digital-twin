...
ts_library(
    name = "cooldown_manager",
    srcs = ["cooldown_manager.ts"],
    deps = [
        ":observability",
        ":platform_adapter",
        ":supabase_client",
...
ts_library(
    name = "zoho_books_adapter",
    srcs = ["zoho_books_adapter.ts"],
    deps = [
        ":cost_source",
    ],
)
...
ts_library(
    name = "quickbooks_adapter",
    srcs = ["quickbooks_adapter.ts"],
    deps = [
        ":cost_source",
    ],
)
